    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="w-full h-auto p-1 bg-transparent flex flex-wrap justify-start items-center gap-1.5 sm:gap-3 border-none shadow-none">
          <TabsTrigger 
            value="upcoming" 
            className="rounded-full border border-border bg-card hover:bg-muted/60 px-2.5 py-1 sm:px-5 sm:py-2.5 text-[11px] sm:text-sm font-medium transition-all duration-300 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:border-primary shadow-sm hover:shadow data-[state=active]:shadow-md"
          >
