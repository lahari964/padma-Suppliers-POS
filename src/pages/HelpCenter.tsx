...
const FAQ_DATA = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How do I mark items as returned?", a: "Find the active bill in the table and open it. Scroll to the 'Items to Return' section. You can return all items at once by clicking 'Return Selected Items', or perform a partial return by modifying the 'Return Qty' box before clicking the button." },
      { q: "How do I log damages for broken items?", a: "When processing a return, check the box next to 'Mark items as damaged'. Enter the quantity that is broken. The system calculates the damage penalty and permanently adds it to the customer's final bill." },
      { q: "How do I dispatch items? Can I do partial dispatches?", a: "Open an Upcoming bill and look under 'Items to Dispatch'. You can change the 'Dispatch Qty' to only dispatch a few items today, and the rest tomorrow. Click 'Dispatch Selected Items' and the bill becomes 'Partially Active'." },
      { q: "How do I add more items to an existing Quotation or Order?", a: "Open the bill, look under 'Items to Dispatch' or 'Order Items', and click the '+ Add New Items to Order' button. Search for the new item, set the quantity, and save." },
      { q: "What is the 'Days' column when adding an item?", a: "The 'Days' column multiplies the daily rate. For example, if a chair is ₹10/day and a customer rents 50 chairs for 3 days, the system calculates: ₹10 × 50 × 3 = ₹1,500 total." },
      { q: "How do I charge a late fee?", a: "When returning items, you can add additional charges like transport or general discounts before you finalize the settlement." },
      { q: "Can I manage or change the Return Date to the past or future?", a: "Yes! When processing a return, you do not have to use today's date. You can freely edit the date field." },
      { q: "How do I track who made changes to a bill?", a: "Scroll to the very bottom of any open bill to find the 'Audit Trail'. It shows a timeline of exactly who did what and when (e.g., 'Admin created the bill', 'Staff logged a payment')." },
      { q: "How do I delete a bill?", a: "Find the bill, click the three dots (⋮) on the right, and select 'Delete'. Warning: This is permanent!" },
      { q: "Can I log damages after a bill is Settled?", a: "Coming soon! Currently, once a bill is Settled, it is permanently locked. We are building a feature to reopen a Settled bill to log a late damage penalty." }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { q: "What is the difference between an Order and a Quotation?", a: "A Quotation is just a price estimate and does NOT deduct stock from your inventory. An Order (Upcoming or Active) officially locks your stock so nobody else can rent those items." },
      { q: "Scenario: Can I partially return items from a single bill (e.g., they rented 10 chairs but only returned 8)?", a: "Yes! Inside the Bill Details, look at the 'Items to Return' section. Modify the 'Return Qty' box from 10 to 8, and click 'Return Selected Items'. The remaining 2 chairs stay out on rent, and the bill status becomes 'Partially Active'." },
