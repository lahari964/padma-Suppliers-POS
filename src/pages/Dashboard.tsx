  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="border-destructive/20 shadow-sm flex flex-col h-full">
          <CardHeader className="pb-3 border-b border-border bg-destructive/5 rounded-t-xl shrink-0">
        ...
        <Card className="flex flex-col h-full">
          ...
          <CardContent className="flex-1 flex flex-col min-h-0">
            <div className="space-y-4 flex-1 flex flex-col min-h-0">
              <div className="grid grid-cols-3 gap-4 border-b border-border pb-4 shrink-0">
                <div 
